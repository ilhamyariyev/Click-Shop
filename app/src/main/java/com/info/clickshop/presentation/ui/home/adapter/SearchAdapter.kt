...
class SearchAdapter : RecyclerView.Adapter<SearchAdapter.ProductHolder>(){


    inner class ProductHolder(private val binding: ItemSearchProductsBinding) : RecyclerView.ViewHolder(binding.root){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ProductHolder {
        val view = ItemSearchProductsBinding.inflate(LayoutInflater.from(parent.context),parent,false)
